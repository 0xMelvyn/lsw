        ...
        <header>
            ...
            <nav className='flex justify-center items-center px-40 pb-6'>
                <ul className={`flex w-screen justify-evenly items-center`}>
                    <li className='w-1/5 px-4'><h1 className={`text-xl font-Metropolis-Regular hover:text-blue-300 transition duration-500 px-8 text-gray-500 flex justify-center mx-auto`}><Link href="/peluches">PELUCHES</Link></h1></li>
